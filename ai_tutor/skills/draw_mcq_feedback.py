...
@skill
async def draw_mcq_feedback(question_id: str, option_id: int, is_correct: bool) -> List[Dict[str, Any]]:
    ...
    # ------------------------------------------------------------------ #
    # We do **not** know the exact number of options from here (since the signature omits it),
    # but a conventional MCQ has <= 6 options.  We pessimistically iterate 0-5 and let FE ignore
